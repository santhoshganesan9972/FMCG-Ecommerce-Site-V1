...
export const mockCustomerReports: CustomerReportEntry[] = [
  { id: "CR-001", customerId: "CUST001", name: "John Doe", email: "john.doe@example.com", totalOrders: 156, totalSpent: 125000, avgOrderValue: 801, lastOrderDate: "2026-05-21", lifetimeValue: "₹1.25L", segment: "gold", acquisitionChannel: "Referral", retentionRate: 92, ordersThisMonth: 12, preferredCategory: "Groceries", city: "Mumbai" },
  { id: "CR-002", customerId: "CUST002", name: "Jane Smith", email: "jane.smith@example.com", totalOrders: 89, totalSpent: 72000, avgOrderValue: 809, lastOrderDate: "2026-05-20", lifetimeValue: "₹72K", segment: "silver", acquisitionChannel: "Organic", retentionRate: 85, ordersThisMonth: 8, preferredCategory: "Fruits", city: "Delhi" },
  { id: "CR-003", customerId: "CUST003", name: "Bob Johnson", email: "bob.johnson@example.com", totalOrders: 42, totalSpent: 32000, avgOrderValue: 762, lastOrderDate: "2026-05-18", lifetimeValue: "₹32K", segment: "bronze", acquisitionChannel: "Paid Ads", retentionRate: 68, ordersThisMonth: 5, preferredCategory: "Snacks", city: "Bangalore" },
  { id: "CR-004", customerId: "CUST004", name: "Alice Brown", email: "alice.brown@example.com", totalOrders: 201, totalSpent: 285000, avgOrderValue: 1418, lastOrderDate: "2026-05-21", lifetimeValue: "₹2.85L", segment: "platinum", acquisitionChannel: "Referral", retentionRate: 96, ordersThisMonth: 18, preferredCategory: "Dairy", city: "Chennai" },
  { id: "CR-005", customerId: "CUST005", name: "Charlie Wilson", email: "charlie.wilson@example.com", totalOrders: 12, totalSpent: 15000, avgOrderValue: 1250, lastOrderDate: "2026-05-15", lifetimeValue: "₹15K", segment: "new", acquisitionChannel: "Email Campaign", retentionRate: 45, ordersThisMonth: 3, preferredCategory: "Beverages", city: "Hyderabad" },
  { id: "CR-006", customerId: "CUST006", name: "Diana Prince", email: "diana.prince@example.com", totalOrders: 78, totalSpent: 84000, avgOrderValue: 1077, lastOrderDate: "2026-05-19", lifetimeValue: "₹84K", segment: "silver", acquisitionChannel: "Social Media", retentionRate: 78, ordersThisMonth: 6, preferredCategory: "Health", city: "Pune" },
  { id: "CR-007", customerId: "CUST007", name: "Eve Adams", email: "eve.adams@example.com", totalOrders: 3, totalSpent: 4500, avgOrderValue: 1500, lastOrderDate: "2026-05-10", lifetimeValue: "₹4.5K", segment: "new", acquisitionChannel: "Paid Ads", retentionRate: 30, ordersThisMonth: 1, preferredCategory: "Home Care", city: "Ahmedabad" },
  { id: "CR-008", customerId: "CUST008", name: "Frank Miller", email: "frank.miller@example.com", totalOrders: 145, totalSpent: 112000, avgOrderValue: 772, lastOrderDate: "2026-05-21", lifetimeValue: "₹1.12L", segment: "gold", acquisitionChannel: "Organic", retentionRate: 88, ordersThisMonth: 14, preferredCategory: "Personal Care", city: "Kolkata" },
];

export const mockVendorReports: VendorReportEntry[] = [
  { id: "VNDR-001", vendorId: "VEND001", vendorName: "Fresh Foods Pvt Ltd", category: "Groceries", totalOrders: 156, grossSales: 125000, commission: 12500, commissionRate: 10, netPayout: 110475, pendingPayout: 0, rating: 4.8, performance: "excellent", onTimeDeliveryRate: 95, returnRate: 2, activeProducts: 45, joinedDate: "2023-01-15", lastPayoutDate: "2026-05-15" },
  { id: "VNDR-002", vendorId: "VEND002", vendorName: "Organic Farms", category: "Fruits & Veg", totalOrders: 89, grossSales: 78500, commission: 7850, commissionRate: 10, netPayout: 69380, pendingPayout: 5000, rating: 4.6, performance: "good", onTimeDeliveryRate: 92, returnRate: 3, activeProducts: 32, joinedDate: "2023-03-20", lastPayoutDate: "2026-05-10" },
  { id: "VNDR-003", vendorId: "VEND003", vendorName: "Daily Essentials Co", category: "Dairy", totalOrders: 234, grossSales: 189000, commission: 18900, commissionRate: 10, netPayout: 167045, pendingPayout: 0, rating: 4.9, performance: "excellent", onTimeDeliveryRate: 98, returnRate: 1, activeProducts: 67, joinedDate: "2024-08-01", lastPayoutDate: "2026-05-18" },
  { id: "VNDR-004", vendorId: "VEND004", vendorName: "Snacks World", category: "Snacks", totalOrders: 67, grossSales: 45600, commission: 4560, commissionRate: 10, netPayout: 40303, pendingPayout: 3000, rating: 4.3, performance: "average", onTimeDeliveryRate: 85, returnRate: 5, activeProducts: 28, joinedDate: "2024-11-10", lastPayoutDate: "2026-05-05" },
  { id: "VNDR-005", vendorId: "VEND005", vendorName: "Beverage Hub", category: "Beverages", totalOrders: 112, grossSales: 98000, commission: 9800, commissionRate: 10, netPayout: 86620, pendingPayout: 0, rating: 4.5, performance: "good", onTimeDeliveryRate: 90, returnRate: 2, activeProducts: 41, joinedDate: "2024-02-28", lastPayoutDate: "2026-05-12" },
  { id: "VNDR-006", vendorId: "VEND006", vendorName: "Health Plus", category: "Health", totalOrders: 45, grossSales: 52000, commission: 5200, commissionRate: 10, netPayout: 45960, pendingPayout: 2000, rating: 3.9, performance: "average", onTimeDeliveryRate: 78, returnRate: 6, activeProducts: 19, joinedDate: "2025-01-20", lastPayoutDate: "2026-05-01" },
];

export const mockInventoryReports: InventoryReportEntry[] = [
  { id: "INV-RPT-001", sku: "RICE-BAS-001", productName: "Organic Basmati Rice", category: "Groceries", warehouse: "WH-01", totalStock: 120, reserved: 14, available: 106, damaged: 0, reorderPoint: 20, daysUntilStockout: 45, monthlyVelocity: 65, turnoverRate: 4.2, stockStatus: "healthy", lastRestocked: "2026-05-10", unitCost: 80, stockValue: 9600 },
  { id: "INV-RPT-002", sku: "FRUIT-APL-001", productName: "Fresh Red Apples", category: "Fruits", warehouse: "WH-02", totalStock: 85, reserved: 6, available: 78, damaged: 1, reorderPoint: 30, daysUntilStockout: 15, monthlyVelocity: 140, turnoverRate: 8.5, stockStatus: "low", lastRestocked: "2026-05-20", unitCost: 120, stockValue: 10200 },
  { id: "INV-RPT-003", sku: "HEALTH-HNY-001", productName: "Natural Honey 500g", category: "Health", warehouse: "WH-01", totalStock: 0, reserved: 0, available: 0, damaged: 0, reorderPoint: 20, daysUntilStockout: 0, monthlyVelocity: 35, turnoverRate: 2.1, stockStatus: "out_of_stock", lastRestocked: "2026-04-28", unitCost: 280, stockValue: 0 },
  { id: "INV-RPT-004", sku: "DAIRY-MLK-001", productName: "Full Cream Milk 1L", category: "Dairy", warehouse: "WH-03", totalStock: 320, reserved: 28, available: 288, damaged: 4, reorderPoint: 100, daysUntilStockout: 2, monthlyVelocity: 1200, turnoverRate: 18.5, stockStatus: "overstocked", lastRestocked: "2026-05-22", unitCost: 45, stockValue: 14400 },
  { id: "INV-RPT-005", sku: "BEV-COF-001", productName: "Cold Brew Coffee 250ml", category: "Beverages", warehouse: "WH-01", totalStock: 42, reserved: 8, available: 33, damaged: 1, reorderPoint: 50, daysUntilStockout: 10, monthlyVelocity: 90, turnoverRate: 6.8, stockStatus: "critical", lastRestocked: "2026-05-18", unitCost: 95, stockValue: 4000 },
  { id: "INV-RPT-006", sku: "SNK-CHP-001", productName: "Baked Multigrain Chips", category: "Snacks", warehouse: "WH-02", totalStock: 210, reserved: 22, available: 185, damaged: 3, reorderPoint: 60, daysUntilStockout: 20, monthlyVelocity: 280, turnoverRate: 10.2, stockStatus: "healthy", lastRestocked: "2026-05-15", unitCost: 60, stockValue: 12600 },
];
