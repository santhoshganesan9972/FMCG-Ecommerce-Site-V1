...
import { mockTaxReports } from "@/data/finance";
...
export default function TaxReportsTable() {
  ...
  const totalTDS = filteredReports.reduce((sum, r) => sum + r.tdsCollected, 0);
  const totalTCS = filteredReports.reduce((sum, r) => sum + r.tcsCollected, 0);
  const totalTax = filteredReports.reduce((sum, r) => sum + r.totalTax, 0);
      ...
      <div className="grid grid-cols-1 gap-3 border-b border-[#e8e8e8] p-4 sm:grid-cols-4">
        <div className="rounded-xl bg-[#f0f9ff] p-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-[#666]">Total Periods</span>
          </div>
        ...
        <div className="rounded-xl bg-[#e8f5e9] p-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-[#666]">Total TDS</span>
          </div>
        ...
        <div className="rounded-xl bg-[#f0f9ff] p-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs font-bold text-[#666]">Total TCS</span>
          </div>
          <p className="mt-1 text-2xl font-black text-[#0369a1]">
        ...
        <table className="w-full min-w-[900px]">
          <thead>
            <tr className="border-b border-[#e8e8e8] bg-[#f6f7f6] text-left text-xs font-black uppercase tracking-wide text-[#666]">
              ...
              <th className="px-4 py-3 text-right">TDS Collected</th>
              <th className="px-4 py-3 text-right">TCS Collected</th>
              ...
              >
                ...
                <td className="px-4 py-4 text-right">
                  <span className="font-medium text-[#0c831f]">
                    {formatCurrency(report.tdsCollected)}
                  </span>
                </td>
                <td className="px-4 py-4 text-right">
                  <span className="font-medium text-[#0369a1]">
                    {formatCurrency(report.tcsCollected)}
                  </span>
                </td>
                <td className="px-4 py-4 text-right">
