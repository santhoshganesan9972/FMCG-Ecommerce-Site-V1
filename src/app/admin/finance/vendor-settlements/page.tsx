...
import VendorSettlementsTable from "@/components/ui/admin/vendor-settlements-table";
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-sm leading-6 text-[#666]">
                Manage vendor payouts, track settlements, and process commission deductions.
              </p>
            </div>
          </div>
        </section>
