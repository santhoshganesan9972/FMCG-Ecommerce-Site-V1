        ...
        <section className="rounded-2xl border border-[#e8e8e8] bg-white p-5 shadow-sm sm:p-6">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              ...
              <h1 className="mt-1 text-2xl font-black text-[#1a1a1a] sm:text-3xl">User Management</h1>
              <p className="mt-2 text-sm text-[#666]">Manage admin users, roles, and access permissions.</p>
            </div>
