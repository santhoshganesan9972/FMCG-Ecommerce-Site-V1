...
const permissionGroups: Permission[] = [
  {
    ...
    permissions: [
      ...
      { key: "dashboard.export", label: "Export Reports", enabled: false },
    ],
  },
  {
    module: "Orders",
    icon: List,
    permissions: [
      { key: "orders.view", label: "View Orders", enabled: false },
      { key: "orders.create", label: "Create Orders", enabled: false },
  ...
  },
  {
    ...
    icon: Boxes,
    permissions: [
      { key: "inventory.view", label: "View Inventory", enabled: false },
      { key: "inventory.edit", label: "Edit Stock", enabled: false },
  ...
  },
  {
    ...
    icon: Tag,
    permissions: [
      { key: "products.view", label: "View Products", enabled: false },
      { key: "products.create", label: "Create Products", enabled: false },
      { key: "products.edit", label: "Edit Products", enabled: false },
  ...
  },
  {
    ...
    icon: Users,
    permissions: [
      { key: "customers.view", label: "View Customers", enabled: false },
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "vendors.delete", label: "Delete Vendors", enabled: false },
    ],
  },
  {
    module: "Finance",
    icon: CreditCard,
    permissions: [
      { key: "finance.view", label: "View Transactions", enabled: false },
      { key: "finance.refund", label: "Process Refunds", enabled: false },
      { key: "finance.settlements", label: "Manage Settlements", enabled: false },
      { key: "finance.reports", label: "View Reports", enabled: false },
    ],
  },
  {
    module: "Promotions",
    icon: Tag,
    permissions: [
      { key: "promotions.view", label: "View Promotions", enabled: false },
      { key: "promotions.create", label: "Create Promotions", enabled: false },
      { key: "promotions.edit", label: "Edit Promotions", enabled: false },
    ],
  },
  {
    module: "Settings",
  ...
  },
  {
    ...
    permissions: [
      ...
      { key: "users.create", label: "Create Users", enabled: false },
      { key: "users.edit", label: "Edit Users", enabled: false },
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              <p className="mt-2 max-w-2xl text-sm text-[#666]">
                Define a new role with granular permissions. Select the modules and
                specific actions this role will have access to.
              </p>
            </div>
          </div>
        </section>
