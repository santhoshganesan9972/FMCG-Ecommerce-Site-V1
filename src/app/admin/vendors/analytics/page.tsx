    ...
    <DashboardLayout>
      <div className="space-y-4 p-2 sm:p-4">
        <section className="rounded-2xl border border-[#e8e8e8] bg-white p-5 shadow-sm sm:p-6">
          ...
          <h1 className="mt-1 text-2xl font-black text-[#1a1a1a] sm:text-3xl">Vendor Analytics</h1>
          <p className="mt-2 text-sm text-[#666]">Performance metrics across all vendors on the platform.</p>
        </section>
